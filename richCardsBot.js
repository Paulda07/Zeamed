...
class RichCardsBot extends MyBot {

    constructor(conversationState, userState, dialog, logger, configuration, {}) {

        super(conversationState, userState, dialog, logger, configuration, {});
